                ...
                <div className="flex flex-col md:flex-row justify-between">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{invoice.generatedBy} {invoice.generatorName ? `(${invoice.generatorName})` : ''}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-gray-200">
                      ...
                      <p className="text-sm text-gray-500">{invoice.client.type}</p>
                      {invoice.client.address && (
                        <p className="text-sm text-gray-500 mt-2">{invoice.client.address}</p>
                      )}
                      {invoice.client.email && (
                        <p className="text-sm text-gray-500 mt-1">{invoice.client.email}</p>
                      )}
                      {invoice.client.phone && (
                        <p className="text-sm text-gray-500 mt-1">{invoice.client.phone}</p>
                      )}
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h3 className="font-medium mb-3">Terms and Conditions</h3>
                    <p className="text-sm text-gray-600">
