...
import { ArrowLeft, Edit, Trash2, Mail, Phone, Calendar, Clock, Shield, Key, AlertTriangle } from 'lucide-react';
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                  <div className="p-6 border-b border-gray-200">
                    <div className="flex justify-between items-center">
                      <h2 className="text-xl font-semibold text-gray-900">Admin User Profile</h2>
                      <div className="flex gap-2">
                        <button
                          onClick={handleEdit}
                          className="flex items-center gap-1 px-3 py-1.5 bg-blue-600 text-white rounded-md hover:bg-blue-700"
                          disabled={currentUser?.id === adminUser.id || (adminUser.role === 'super_admin' && currentUser?.role !== 'super_admin')}
                        >
                          <Edit size={16} />
                          <span>Edit</span>
                        </button>
                  ...
                  <div className="p-6">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">{adminUser.name}</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-gray-900">{adminUser.createdAt}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-gray-900">{adminUser.lastActive || 'Unknown'}</p>
                            </div>
                          </div>
                        </div>
